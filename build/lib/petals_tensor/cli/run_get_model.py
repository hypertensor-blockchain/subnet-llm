...
def main():
  ...
  # logger.info("Model ID1:          %s" % substrate_config.SubnetDataConfig().get_test())
  # logger.info("Model ID2:          %s" % substrate_config.SubnetDataConfig().test)

  # logger.info("Model ID:          %s" % substrate_config.SubnetDataConfig().id)
  # logger.info("Model Path:        %s" % substrate_config.SubnetDataConfig().path)
  # logger.info("Model Initialized: %s" % substrate_config.SubnetDataConfig().initialized)
