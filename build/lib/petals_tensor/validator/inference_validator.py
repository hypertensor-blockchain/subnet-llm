...
class InferenceValidator(threading.Thread):
    ...
    def run_inference(
        ...
        if peers is not None:
            ...
            # decoded = [self.tokenizer.decode(x) for x in inference_data["outputs"]]
            # print("run_inference decoded", decoded)
    ...
    def validate_inference(
        ...
        try:
            ...
            if inference_data is not None:
                ...
                logger.info(f"Tensor sum diff is:              {expected_outputs_tensor_sum - outputs_tensor_sum}/{outputs_tensor_sum - expected_outputs_tensor_sum}")
                ...
                return torch.allclose(expected_outputs, outputs, rtol=RTOL, atol=ATOL, equal_nan=False)
            else:
                return False
        except Exception as e:
